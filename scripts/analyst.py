...
{{"title": "AI名で○○する（30文字以内）", "problem_context": "解決する課題（40文字以内）", "recommended_ai": {{"model": "推奨AIモデル名", "reason": "推奨理由（30文字以内）", "badge_color": "orange"}}, "use_cases": ["具体的なシーン1", "具体的なシーン2", "具体的なシーン3"], "steps": ["具体的な手順1", "具体的な手順2", "具体的な手順3", "具体的な手順4"], "prompt": "そのまま使える完成したプロンプト（変数なし、150文字以内）", "tags": ["タグ1", "タグ2"]}}
