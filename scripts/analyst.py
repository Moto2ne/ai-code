...
{{"title": "戦術タイトル（〜で○○する形式、25文字以内）", "problem_context": "解決する課題（40文字以内）", "recommended_ai": {{"model": "推奨AIモデル名", "reason": "推奨理由（30文字以内）", "badge_color": "orange"}}, "use_cases": ["〜したい時", "〜したい時", "〜したい時"], "steps": ["手順1", "手順2", "手順3", "手順4"], "prompt": "実際に使えるプロンプト（改行なし、150文字以内）", "tags": ["タグ1", "タグ2"]}}
